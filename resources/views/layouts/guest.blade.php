    ...
    <body class="antialiased" style="background: #FBF8F3; color: rgb(27, 42, 74);">
        <div class="min-h-screen flex flex-col" style="background: #FBF8F3;">
            ...
            <div class="flex-1 flex flex-col items-center justify-center px-4 py-12">
                <div style="width: 100%; max-width: 420px; background: rgb(255, 255, 255); border: 1px solid rgba(27, 42, 74, 0.1); border-radius: 16px; padding: 32px; box-shadow: rgba(27, 42, 74, 0.08) 0px 8px 30px -8px;">
                    {{ $slot }}
                </div>
            </div>
