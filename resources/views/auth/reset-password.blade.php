<x-guest-layout>
    <div class="mb-6" style="text-align: center;">
        <h2 style="font-family: 'Source Serif 4', serif; font-weight: 700; font-size: 26px; color: rgb(27, 42, 74); margin-bottom: 6px;">Reset Password</h2>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mt-4">
            <label for="password_confirmation" style="display: block; font-size: 14px; font-weight: 500; color: rgb(27, 42, 74); margin-bottom: 6px;">{{ __('Confirm Password') }}</label>
